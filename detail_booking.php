                            ...
                            <div class="row">
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <button class="btn btn-icon btn-3 btn-primary" type="button">
                                        <a href="edit_booking.php?NIK=<?php echo $hasil_array['NIK']; ?>"
                                    ...
                                    <button class="btn btn-icon btn-3 btn-danger" type="button">
                                        <a href="act_hapus_booking.php?NIK=<?php echo $hasil_array['NIK']; ?>"
                                            class="btn-inner--icon text-white"><i class="fa fa-trash"
                                                aria-hidden="true"></i>
                                        </a>
                                        <a href="act_hapus_booking.php?NIK=<?php echo $hasil_array['NIK']; ?>"
                                            class="btn-inner--text text-white ms-2">Hapus</a>
                                    </button>
                                </div>
                            </div>
                        </form>
