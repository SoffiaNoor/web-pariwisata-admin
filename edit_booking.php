...
<body class="g-sidenav-show" style="background: linear-gradient(45deg, #034c5a, #01353f);">
    ...
    $query = "SELECT * FROM booking_uuid WHERE NIK = '$NIK'";
            ...
            <div class="row">
                <div class="col-lg-12 mb-lg-0 mb-4 shadow-xl">
                    <div class="card p-2">
                        ...
                        <form class="p-3" id="form_edit_booking" name="form_edit_booking" method="post"
                            action="act_edit_booking.php">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>NIK</label>
                                        <input type="text" name="NIK" id="NIK" class="form-control"
                                            value="<?php echo $hasil_array['NIK']; ?>" readonly />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Nama" id="Nama" class="form-control"
                                            id="exampleFormControlInput1" value="<?php echo $hasil_array['Nama']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="Usia" id="Usia" class="form-control"
                                            id="exampleFormControlInput1" value="<?php echo $hasil_array['Usia']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="Destinasi" name="Destinasi">
                                            <?php
                                            $destinations = array("Wajag Island", "Waigeo", "Mansuar");
                                            foreach ($destinations as $destination) {
                                                $selected = ($hasil_array['Destinasi'] == $destination) ? 'selected' : '';
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="TanggalBooking"
                                            id="TanggalBooking" value="<?php echo $hasil_array['TanggalBooking']; ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="Email" id="Email"
                                            value="<?php echo $hasil_array['Email']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 pt-2">
                                    ...
                                    <button class="btn btn-icon btn-3 btn-success" type="submit" name="button_simpan"
                                        id="button_simpan" value="Simpan">
                                    ...
                                    <button type="button" class="btn bg-gradient-danger" data-bs-toggle="modal"
                                        ...
                                        <i class="fa fa-trash"></i><span class="ms-2">Hapus</span>
                                    </button>
                                </div>
                            </div>
                        </form>
